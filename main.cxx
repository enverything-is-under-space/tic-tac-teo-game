...
void tttgame::computer_initial_move(int computerid)
{
    ...
    int result_move = move(computerid,rand() % 9 + 1);

    while(!result_move)
    {
        cout << "the random cell were full, i'll try again find another cell." <<endl;
        result_move = move(computerid,rand() % 9 + 1);
    }
}
...
int main()
{
   ...
   cout << "[INPUT] do you want play first? type to answer ja oder nein mit: y oder n:";
//            int x=b.move(player_id,1);
//            cout << x; ---------------------------what is this
...
//        b.move(computer_id, b.computer_move());
   }
